"""Checkbox showcase FastAPI application using hybrid Jinja + htmy approach.

Run with: python examples/checkboxes.py
...
app = FastAPI(title="Flowbite-HTMY Checkbox Showcase")
...
async def index() -> dict:
    """Render the checkbox showcase page using Jinja layout + htmy components."""

    # Build comprehensive checkbox showcase
    checkboxes_section = html.div(
        ...
        html.div(
            ...
            html.fieldset(
                ...
                Checkbox(
                    id="color-yellow", name="colors", value="yellow", label="Yellow"
                ),
            ),
            class_="mb-8 p-6 bg-white dark:bg-gray-800 rounded-lg shadow",
        ),
                ...
                html.table(
                    html.thead(
                        html.tr(
                            ...
                            html.th(
                                "Product name", scope="col", class_="px-6 py-3"
                            ),
    ...
    rendered_checkboxes = await renderer.render(checkboxes_section)

    return {
        "title": "Checkbox Showcase - Flowbite HTMY",
        "heading": "Checkbox Component",
        "description": "Form checkbox fields with validation states, helper text, and dark mode support.",
        "content": rendered_checkboxes,
    }
