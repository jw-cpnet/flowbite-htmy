...
from flowbite_htmy.components import Button, Modal
...
async def index() -> dict:
    ...
    modals_section = html.div(
        ...
        # Popup modal (confirmation/delete) - Custom layout with raw HTML
        html.h2(
            "Popup modal",
            class_="text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-12",
        ),
        html.p(
            "Use a popup modal for confirmation dialogs, destructive actions, or important warnings. This example uses raw HTML for a custom layout.",
            class_="text-gray-600 dark:text-gray-400 mb-6",
        ),
        html.div(
            Button(
        ...
        # Popup modal uses raw HTML because it has unique structure (no standard header/footer)
        SafeStr(
            """
