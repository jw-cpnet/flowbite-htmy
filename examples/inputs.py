"""Input showcase FastAPI application using hybrid Jinja + htmy approach.
...
Run with: python examples/inputs.py
...
app = FastAPI(title="Flowbite-HTMY Input Showcase")
...
async def index() -> dict:
    """Render the input showcase page using Jinja layout + htmy components."""

    # Build comprehensive input showcase
    inputs_section = html.div(
        # Basic input fields
        html.h2(
            "Basic input fields",
    ...
    rendered_inputs = await renderer.render(inputs_section)

    return {
        "title": "Input Showcase - Flowbite HTMY",
        "heading": "Input Component",
        "description": "Form input fields with labels, validation states, and helper text.",
        "content": rendered_inputs,
    }
