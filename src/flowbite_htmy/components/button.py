...
class Button:
    ...
    def _build_classes(self, theme: ThemeContext) -> str:
        ...
        builder = ClassBuilder(
            "font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:ring-4 focus:outline-none"
        )
    ...
    def _get_color_classes(self) -> str:
        ...
        color_map = {
            ...
            Color.SECONDARY: "text-gray-900 bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-gray-100",
    ...
    def _get_dark_color_classes(self) -> str:
        ...
        dark_map = {
            ...
            Color.SECONDARY: "dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700",
