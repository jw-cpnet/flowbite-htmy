...
- Python 3.11+ + htmy 0.1.0+, ClassBuilder, ThemeContext, Icon system, Flowbite CSS 2.5.1, Flowbite JavaScript, HTMX 2.0.2 (007-dropdown)
- Python 3.11+ (existing project requirement) + htmy 0.1.0+, ClassBuilder, ThemeContext, Icon system (get_icon()), Flowbite CSS 2.5.1, Flowbite JavaScript 2.5.1, HTMX 2.0.2 (optional) (008-drawer)
